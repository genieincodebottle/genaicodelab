...
from non_agentic_rag.adaptive_rag import AdaptiveRAG
...
def init_session_state():
    ...
    if 'rag_type' not in st.session_state:
        st.session_state.rag_type = "Adaptive RAG"
...
display_selected_rag_info(st.session_state.get('rag_type', "Adaptive RAG"))
...
with st.sidebar:
    ...
    rag_type = st.selectbox(
        "Select RAG Type",
        options=RAG_TYPES,
        index=RAG_TYPES.index(st.session_state.get('rag_type', "Adaptive RAG")),
